...
// eslint-disable  MS80OmFIVnBZMlhtbTc3bHY1Zm9pYTg2Vm1GaE5nPT06OGNlYmExMmM=
...
// TODO  Mi80OmFIVnBZMlhtbTc3bHY1Zm9pYTg2Vm1GaE5nPT06OGNlYmExMmM=
...
export const MultimodalPreview: React.FC<MultimodalPreviewProps> = ({
  ...
  if (block.type === "file" && block.mimeType === "application/pdf") {
    ...
    return (
      <div
        className={cn(
          "relative flex max-w-full items-start gap-2 rounded-md border bg-gray-100 px-3 py-2",
          className,
        )}
      >
...
// FIXME  My80OmFIVnBZMlhtbTc3bHY1Zm9pYTg2Vm1GaE5nPT06OGNlYmExMmM=
